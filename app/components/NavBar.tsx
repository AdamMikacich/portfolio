...
export default function NavBar() {
  return (
    <header className="h-16 sticky top-0 z-50 flex items-center justify-between bg-white px-4 py-4 shadow-md shadow-slate-900/5 transition duration-500 dark:shadow-none sm:px-6 lg:px-8 dark:bg-slate-900">
